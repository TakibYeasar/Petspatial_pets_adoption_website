        ...
        <div className="container mx-auto py-8">
          <div className="flex flex-col lg:flex-row items-center space-y-8 lg:space-y-0 lg:space-x-8">
            ...
            <div className="lg:w-1/2">
              ...
              <a className="inline-block mt-4 px-6 py-3 text-white bg-blue-600 hover:bg-blue-700 rounded-lg" href="#">Read More</a>
            </div>
          </div>
        ...
        <div className="container mx-auto">
          <div className="flex flex-col lg:flex-row lg:space-x-8">
            <div className="lg:w-1/2 flex flex-col justify-center">
              ...
              <a href="#" className="inline-block mt-4 sm:mt-5 px-6 py-3 bg-blue-600 text-white rounded hover:bg-blue-700 transition">Read More</a>
            </div>
